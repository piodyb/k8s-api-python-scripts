...
name = '10.122.154.20' # str | name of the Node
...
for i in ret.items:
    ...
    print(pod_name)
    body = kubernetes.client.V1beta1Eviction(metadata=kubernetes.client.V1ObjectMeta(name=pod_name, namespace=node_namespaces,deletion_grace_period_seconds=300))
